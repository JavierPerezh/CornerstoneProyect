...
async def transcribir_audio(audio_path: str) -> str:
	...
	try:
		...
		# Permite continuar el pipeline de voz en modo degradado cuando el motor no está disponible.
		return "No pude transcribir el audio con precision. Describe tus sintomas en texto para ayudarte mejor."
	finally:
		try:
